...
export class CabinetsCoverPlateHandler extends BaseShapeHandler {
  ...
  private renderBackground(
    ...
    builder.close();
    builder.moveTo(10, 0.5 * height - 12.5);
    builder.lineTo(10, 0.5 * height + 12.5);
    builder.lineTo(width - 10, 0.5 * height + 12.5);
    builder.lineTo(width - 10, 0.5 * height - 12.5);
    builder.close();
