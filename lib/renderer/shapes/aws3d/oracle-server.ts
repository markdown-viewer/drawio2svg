...
export class Aws3dOracleServerHandler extends BaseShapeHandler {
  ...
  private renderForeground(
    ...
    builder.setFillColor(x as string);
    builder.begin();
    builder.moveTo(0.374 * width, 0.3873 * height);
    builder.arcTo(0.0325 * width, 0.01764 * height, 0, 0, 1, 0.374 * width, 0.3626 * height);
    builder.lineTo(0.4797 * width, 0.3098 * height);
    builder.arcTo(0.0325 * width, 0.0141 * height, 0, 0, 1, 0.5203 * width, 0.3098 * height);
    builder.lineTo(0.626 * width, 0.3626 * height);
    builder.arcTo(0.0325 * width, 0.01764 * height, 0, 0, 1, 0.626 * width, 0.3852 * height);
    builder.lineTo(0.5203 * width, 0.438 * height);
    builder.arcTo(0.0325 * width, 0.0141 * height, 0, 0, 1, 0.4797 * width, 0.438 * height);
    builder.close();
    builder.fill();
    builder.setStrokeWidth(2 * extra1);
    builder.setStrokeColor(extra2 as string);
