...
export class Aws3dDashedEdgeDouble2Handler extends BaseShapeHandler {
  ...
  render(attrs: ShapeAttrs): void {
    ...
    builder.begin();
    builder.moveTo(21, 5.5);
    builder.lineTo(0, 0);
    builder.lineTo(9.7, 12.2);
    builder.fillAndStroke();
    builder.begin();
    builder.moveTo(width - 21, height - 5.5);
    ...
    builder.begin();
    builder.moveTo(7.675, 4.425);
    builder.lineTo(width - 7.675, height - 4.425);
    builder.stroke();
    builder.restore();
  }
}
