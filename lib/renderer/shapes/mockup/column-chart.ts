...
export class MockupColumnChartHandler extends BaseShapeHandler {
  ...
  private render_bars(builder: RenderContext['builder'], p1: any, p2: any, p3: any, p4: any): void {
    ...
    builder.rect(0.2 * p3, 0.25 * p4, 0.05 * p3, 0.75 * p4);
    builder.fillAndStroke();
    builder.rect(0.45 * p3, 0.4 * p4, 0.05 * p3, 0.6 * p4);
    builder.fillAndStroke();
    builder.rect(0.7 * p3, 0.05 * p4, 0.05 * p3, 0.95 * p4);
    builder.fillAndStroke();
    builder.setFillColor(g as string);
    builder.rect(0.25 * p3, 0.15 * p4, 0.05 * p3, 0.85 * p4);
    builder.fillAndStroke();
    builder.rect(0.5 * p3, 0.35 * p4, 0.05 * p3, 0.65 * p4);
    builder.fillAndStroke();
    builder.rect(0.75 * p3, 0.2 * p4, 0.05 * p3, 0.8 * p4);
    builder.fillAndStroke();
