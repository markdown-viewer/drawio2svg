...
export class MockupFormsWedgeBarHandler extends BaseShapeHandler {
  ...
  render(attrs: ShapeAttrs): void {
    ...
    for (
      ...
      q = this.measureTextSize(q, f, 'Arial,Helvetica,sans-serif', 0).width;
      m[p] = 0 === q ? 42 : q;
      l += m[p];
    }
    b = Math.max(b, l);
  ...
  private render_focusTab(
    ...
    if (!builder) return;
    p1 = this.getStyleValue(this.renderCtx.style, 'tabStyle', 'block');
    p2 = this.getStyleValue(this.renderCtx.style, 'fillColor2', '#008cff');
    ...
    for (p2 = 0; p2 <= p10; p2++) {
      ...
      if (p10 === p2) {
        if (p1 === 'block') {
          ...
          builder.moveTo(p5, p4);
          builder.lineTo(p5, 0);
          builder.lineTo(p5 + p8, 0);
          builder.lineTo(p5 + p8, p4);
        } else if (p1 === 'cone') {
          builder.begin();
          builder.moveTo(p5, p4);
          builder.lineTo(p5 + 0.5 * p7, 0);
          builder.lineTo(p5 + p8 - 0.5 * p7, 0);
          builder.lineTo(p5 + p8, p4);
        } else if (p1 === 'halfCone') {
          builder.begin();
          builder.moveTo(p5, p4);
          ...
          builder.lineTo(p5, p3);
          builder.arcTo(p3, p3, 0, 0, 1, p5 + p3, 0);
          builder.lineTo(p5 + p8 - p3, 0);
          builder.arcTo(p3, p3, 0, 0, 1, p5 + p8, p3);
          builder.lineTo(p5 + p8, p4 - p3);
          builder.arcTo(p3, p3, 0, 0, 0, p5 + p8 + p3, p4);
        }
        builder.fillAndStroke();
      }
      p5 = p5 + p8 + p6;
