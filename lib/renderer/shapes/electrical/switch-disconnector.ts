...
export class ElectricalElectroMechanicalSwitchDisconnectorHandler extends BaseShapeHandler {
  ...
  render(attrs: ShapeAttrs): void {
    ...
    builder.lineTo(0.24 * width, 0.84 * height);
    if ('off' == d) {
      builder.lineTo(0.76 * width, 0);
    } else {
      builder.lineTo(0.8 * width, 0.84 * height);
    }
    builder.stroke();
