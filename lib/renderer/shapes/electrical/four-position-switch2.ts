...
export class ElectricalElectroMechanicalFourPositionSwitch2Handler extends BaseShapeHandler {
  ...
  render(attrs: ShapeAttrs): void {
    ...
    builder.moveTo(0.37 * width, 0.145 * height);
    builder.arcTo(0.2 * width, 0.22 * height, 0, 0, 0, 0.165 * width, 0.36 * height);
    if ('1' == d) {
      builder.moveTo(0.32 * width, 0.7 * height);
      builder.arcTo(0.25 * width, 0.25 * height, 0, 0, 1, 0.68 * width, 0.7 * height);
      builder.moveTo(0.32 * width, 0.3 * height);
      builder.arcTo(0.25 * width, 0.25 * height, 0, 0, 0, 0.68 * width, 0.3 * height);
      builder.moveTo(0.46 * width, 0.37 * height);
      builder.lineTo(0.46 * width, 0.63 * height);
      builder.moveTo(0.54 * width, 0.37 * height);
      builder.lineTo(0.54 * width, 0.63 * height);
      builder.moveTo(0.28 * width, 0.5 * height);
      builder.lineTo(0.72 * width, 0.5 * height);
    } else if ('2' == d) {
      ...
      builder.moveTo(0.61 * width, 0.44 * height);
      builder.lineTo(0.45 * width, 0.61 * height);
      builder.moveTo(0.32 * width, 0.32 * height);
      builder.lineTo(0.68 * width, 0.68 * height);
    } else if ('3' == d) {
      builder.moveTo(0.7 * width, 0.32 * height);
      builder.arcTo(0.25 * width, 0.25 * height, 0, 0, 0, 0.7 * width, 0.68 * height);
      builder.moveTo(0.3 * width, 0.32 * height);
      builder.arcTo(0.25 * width, 0.25 * height, 0, 0, 1, 0.3 * width, 0.68 * height);
      builder.moveTo(0.37 * width, 0.46 * height);
      builder.lineTo(0.63 * width, 0.46 * height);
      builder.moveTo(0.37 * width, 0.54 * height);
      builder.lineTo(0.63 * width, 0.54 * height);
      ...
      builder.moveTo(0.39 * width, 0.44 * height);
      builder.lineTo(0.55 * width, 0.61 * height);
      builder.moveTo(0.68 * width, 0.32 * height);
    ...
    builder.begin();
    builder.moveTo(0.367 * width, 0.1 * height);
    builder.lineTo(0.367 * width, 0.185 * height);
    builder.lineTo(0.44 * width, 0.1425 * height);
    builder.close();
    builder.moveTo(0.205 * width, 0.355 * height);
    builder.lineTo(0.125 * width, 0.355 * height);
    builder.lineTo(0.165 * width, 0.435 * height);
    builder.close();
    builder.fillAndStroke();
    builder.restore();
  }
