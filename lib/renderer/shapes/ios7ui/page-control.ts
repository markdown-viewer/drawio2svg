...
export class Ios7uiPageControlHandler extends BaseShapeHandler {
  ...
  render(attrs: ShapeAttrs): void {
    ...
    builder.fill();
    builder.ellipse(0.25 * width - 0.5 * f, 0.5 * height - f, 2 * f, 2 * f);
    builder.fill();
    builder.ellipse(0.5 * width - f, 0.5 * height - f, 2 * f, 2 * f);
    builder.fill();
    builder.ellipse(0.75 * width - 1.5 * f, 0.5 * height - f, 2 * f, 2 * f);
    builder.fill();
