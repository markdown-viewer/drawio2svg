...
export class IosIButtonBackHandler extends BaseShapeHandler {
  ...
  private renderBackground(
    ...
    rSize = 2.5;
    builder.begin();
    builder.moveTo(width, rSize);
    builder.arcTo(rSize, rSize, 0, 0, 0, width - rSize, 0);
    builder.lineTo(10, 0);
    builder.lineTo(0.87, 0.5 * height - 0.75);
    builder.arcTo(rSize, rSize, 0, 0, 0, 0.87, 0.5 * height + 0.75);
    builder.lineTo(10, height);
    builder.lineTo(width - rSize, height);
    builder.arcTo(rSize, rSize, 0, 0, 0, width, height - rSize);
    builder.close();
    builder.fill();
  }
