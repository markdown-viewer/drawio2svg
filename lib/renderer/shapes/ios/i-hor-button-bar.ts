...
export class IosIHorButtonBarHandler extends BaseShapeHandler {
  ...
  private renderBackground(
    ...
    for (extra5 = 1; extra5 < height; extra5++) {
      if (extra5 !== extra8 && extra5 !== extra8 + 1) {
        for (q = extra7 = 0; q < extra5; q++) {
          extra7 += extra1[q] + 2 * extra2;
        }
        extra7 = (extra7 * x) / extra3;
        builder.moveTo(extra7, 0);
        builder.lineTo(extra7, y);
      }
    }
    builder.stroke();
    extra7 = 0;
    ...
    for (extra5 = 0; extra5 < extra8; extra5++) {
      extra7 += extra1[extra5] + 2 * extra2;
    }
    extra7 = (extra7 * x) / extra3;
    extra1 = ((extra1[extra8] + 2 * extra2) * x) / extra3;
    extra1 += extra7;
    if (0 === extra8) {
      builder.setGradient('#5D7585', '#008cff', 0, 0, extra1, y, 'south', 1, 1);
      builder.begin();
      builder.moveTo(0, width);
      builder.arcTo(width, width, 0, 0, 1, width, 0);
      ...
      builder.setGradient('#5D7585', '#008cff', extra7, 0, extra1 - extra7, y, 'south', 1, 1);
      builder.begin();
      builder.moveTo(extra7, 0);
