...
export class IosIKeybSymbHandler extends BaseShapeHandler {
  ...
  private renderForeground(
    ...
    builder.fill();
    builder.text(0.0718 * width, 0.625 * height, 0, 0, '123', 'center', 'middle', 0, 0, 0);
