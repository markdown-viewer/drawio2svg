...
export class IosIDeleteAppHandler extends BaseShapeHandler {
  ...
  private renderForeground(
    ...
    builder.begin();
    builder.moveTo(0.3 * width, 0.3 * height);
    builder.lineTo(0.7 * width, 0.7 * height);
    builder.moveTo(0.3 * width, 0.7 * height);
