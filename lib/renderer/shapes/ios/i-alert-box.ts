...
export class IosIAlertBoxHandler extends BaseShapeHandler {
  ...
  private renderForeground(
    ...
    builder.roundrect(0, 0, width, height, extra1, extra1);
    builder.stroke();
    builder.setGradient('#497198', '#c5cee1', 5, height - 50, width - 20, 20, 'south', 1, 1);
    builder.roundrect(5, height - 25, width - 10, 20, 2.5, 2.5);
    builder.fillAndStroke();
    ...
    builder.text(0.5 * width, 0.4 * height, 0, 0, x[2], 'center', 'middle', 0, 0, 0);
    builder.text(0.5 * width, 0.55 * height, 0, 0, x[3], 'center', 'middle', 0, 0, 0);
    builder.setFontSize(Number.parseFloat(String(8.5)) || 0);
    builder.text(0.5 * width, height - 15, 0, 0, x[1], 'center', 'middle', 0, 0, 0);
  }
}
