...
export class GmdlSliderFocusedHandler extends BaseShapeHandler {
  ...
  private renderBackground(
    ...
    f = this.getStyleValue(style, 'strokeColor', '#ffffff');
    ...
    builder.fillAndStroke();
    builder.begin();
    builder.ellipse(y * width - 0.167 * x, 0.5 * height - 0.167 * x, 0.33 * x, 0.33 * x);
    builder.fillAndStroke();
    builder.setFillColor(f as string);
    builder.setAlpha(0.15);
    builder.begin();
