...
export class Arrows2CalloutQuadArrowHandler extends ActorShapeHandler {
  ...
  render(attrs: ShapeAttrs): void {
    ...
    builder.begin();
    builder.moveTo(0.5 * width + d, 0.5 * height - f);
    builder.lineTo(0.5 * width + f, 0.5 * height - f);
    builder.lineTo(0.5 * width + f, 0.5 * height - d);
    ...
    builder.lineTo(0.5 * width + f, 0.5 * height + d);
    builder.lineTo(0.5 * width + f, 0.5 * height + f);
    builder.lineTo(0.5 * width + d, 0.5 * height + f);
    builder.lineTo(0.5 * width + d, height - e);
    builder.lineTo(0.5 * width + d + g, height - e);
    ...
    builder.lineTo(e, 0.5 * height + d + g);
    ...
    builder.lineTo(0.5 * width - d - g, e);
