...
export class Arrows2CalloutDoubleArrowHandler extends ActorShapeHandler {
  ...
  render(attrs: ShapeAttrs): void {
    ...
    builder.begin();
    builder.moveTo(width / 2 - f, 0);
    builder.lineTo(width / 2 + f, 0);
    builder.lineTo(width / 2 + f, 0.5 * height - d);
    ...
    builder.lineTo(width - e, 0.5 * height + d);
    builder.lineTo(width / 2 + f, 0.5 * height + d);
    builder.lineTo(width / 2 + f, height);
    builder.lineTo(width / 2 - f, height);
    builder.lineTo(width / 2 - f, 0.5 * height + d);
